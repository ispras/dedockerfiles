...
RUN apt update && apt install -y python3.10 python3.10-dev python3.10-distutils
...
RUN pip3 install dist/torch-1.11.0a0+git137096a-cp310-cp310-linux_x86_64.whl
...
WORKDIR /
RUN pip3 install torchvision/dist/torchvision-0.12.0a0+9b5a3fe-cp310-cp310-linux_x86_64.whl
RUN pip3 install torchdata/dist/torchdata-0.3.0a0+fbf097d-py3-none-any.whl
RUN pip3 install torchtext/dist/torchtext-0.12.0a0+d7a34d6-cp310-cp310-linux_x86_64.whl
